...
write_log "Note: On Linux, file extensions are always visible by default in the terminal and file managers." "INFO"
write_log "There is no concept of hiding known file extensions as in Windows." "INFO"

write_log "Action not required on Linux. Script marked as completed." "INFO"
